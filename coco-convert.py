...
def main():
    ...
    existing_file_names = [fn for fn in original_file_names if os.path.isfile(os.path.join('images', fn))]

    renamed_file_names = [rename_file(file_name) for file_name in existing_file_names]
    ...
    for original, renamed in zip(existing_file_names, renamed_file_names):
